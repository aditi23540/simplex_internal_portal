...
$python_executable = 'C:/Users/abhimanyu.banerjee/AppData/Local/Programs/Python/Python313/python.exe'; // Full path from previous successful setup
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    error_log("DEBUG: Running command: $command");
    error_log("DEBUG: Output from Python: $output");
    $auth_message = '';
