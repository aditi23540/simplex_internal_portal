...
<head>
    ...
    <link rel="stylesheet" href="assets/css/kaiadmin.min.css" /> <style>
        html, body {
            height: 100%;
            margin: 0;
...
<body class="login-page-body">
    ...
    <header class="login-header-minimal">
        <div class="navbar-brand-wrapper">
            <img src="assets/img/kaiadmin/simplex_icon.ico" alt="Simplex Logo" class="brand-logo" />
            <span class="brand-text">Simplex Engineering & Foundry Works Pvt. Ltd.
</span>
        </div>
    </header>
    ...
    <main class="login-main-content">
        <div class="card login-card-minimal">
            <div class="card-header text-center">
                <img src="assets/img/kaiadmin/simplex_icon.ico" alt="Portal Login Logo" class="mb-2" >
    ...
    <footer class="login-page-footer">
        ...
        <?php echo $current_year;?>, made with <i class="fa fa-heart heart text-danger"></i> by
                <a href="my portfolio website">Abhimanyu,Yamini</a>
            </div>
