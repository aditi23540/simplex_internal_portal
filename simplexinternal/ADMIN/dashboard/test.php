...
<html lang="en">
  <head>
    ...
    <title>SIMPLEX INTERNAL PORTAL - Test Page</title>
    <meta
        ...
        <div class="container">
          <div class="page-inner">
            <div class="welcome-message">
              <h1 class="page-header-title mt-4">Welcome to Cursor</h1> 
              <p>This is a test page with the same layout as the main dashboard.</p>
            </div>
          </div>
        </div>
