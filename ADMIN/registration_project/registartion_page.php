                     ...
                     <form id="multiPageForm" action="actions/save_registration.php" method="POST" enctype="multipart/form-data" class="mt-4">
                               ...
                               <div class="form-page active" id="page1">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6"><label for="nameAsFor" class="form-label required">Name as per</label><select id="nameAsFor" name="nameAsFor" class="form-select"><option value=""></option><option value="10th_certificate">10th certificate</option><option value="aadhar_card" >Aadhar card</option><option value="pan_card">PAN Card</option></select></div>
                                            <div class="col-md-6"><label for="salutation" class="form-label required">Salutation</label><select id="salutation" name="salutation" class="form-select"><option value=""><option value="Mr.">Mr.</option><option value="Miss">Miss</option><option value="Mrs.">Mrs.</option></select></div>
                                            ...
                                            <div class="col-md-6"><label for="nationality" class="form-label required">Nationality</label><select id="nationality" name="nationality" class="form-select"><option value=""><option value="India">India</option><option value="USA">United States</option></select></div>
                                            <div class="col-md-6"><label for="gender" class="form-label required">Gender</label><select id="gender" name="gender" class="form-select"><option value=""><option value="male">Male</option><option value="female">Female</option></select></div>
                                            <div class="col-md-4"><label for="religion" class="form-label required">Religion</label><select id="religion" name="religion" class="form-select"><option value=""><option value="Hindu" >Hindu</option><option value="Muslim">Muslim</option></select></div>
                                            <div class="col-md-4"><label for="categoryType" class="form-label required">Category</label><select id="categoryType" name="categoryType" class="form-select"><option value=""><option value="General" >General</option><option value="OBC">OBC</option><option value="SC">SC</option><option value="ST">ST</option></select></div>
                                    ...
                                    <fieldset class="mt-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4"><label for="permBirthCountry" class="form-label required">Country</label><select id="permBirthCountry" name="permBirthCountry" class="form-select"><option value=""><option >India</option></select></div>
                                            <div class="col-md-4"><label for="permBirthState" class="form-label required">State</label><select id="permBirthState" name="permBirthState" class="form-select"><option value=""><option value="Delhi" >Delhi</option></select></div>
                                            ...
                                            <div class="col-md-4"><label for="presentBirthCountry" class="form-label required">Country</label><select id="presentBirthCountry" name="presentBirthCountry" class="form-select"><option value=""><option value="India" selv>India</option></select></div>
                                            <div class="col-md-4"><label for="presentBirthState" class="form-label required">State</label><select id="presentBirthState" name="presentBirthState" class="form-select"><option value=""><option value="Delhi">Delhi</option></select></div>
                                            ...
                                            <div class="col-md-4"><label for="bloodGroup" class="form-label">Blood Group</label><select id="bloodGroup" name="bloodGroup" class="form-select"><option value=""><option value="B-">B-</option></select></div>
                               ...
                               <div class="form-page" id="page2">
                                    ...
                                    <fieldset id="spouseDetailsSection" class="mt-4 conditional-section" style="display: none;">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6"><label for="spouseName" class="form-label required">Spouse's Name</label><input type="text" id="spouseName" name="spouseName" class="form-control" value="Priya Singh"></div>
                                            <div class="col-md-6"><label for="spouseDob" class="form-label required">Spouse's Date of Birth</label><input type="date" id="spouseDob" name="spouseDob" class="form-control" value="1993-07-22"></div>
                                            <div class="col-md-6"><label for="spouseOccupation" class="form-label required">Spouse's Occupation</label><input type="text" id="spouseOccupation" name="spouseOccupation" class="form-control" value="Software Developer"></div>
                                            <div class="col-md-6"><label for="spouseMobile" class="form-label">Spouse's Mobile</label><input type="tel" id="spouseMobile" name="spouseMobile" class="form-control" value="9876500001"></div>
                                            <div class="col-12"><label for="spouseAddress" class="form-label required">Spouse's Address</label><input type="text" id="spouseAddress" name="spouseAddress" class="form-control" value="HNo 123, Example Street, New Delhi"></div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="mt-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6"><label for="fatherNameP2" class="form-label required">Father's Name</label><input type="text" id="fatherNameP2" name="fatherNameP2" class="form-control" value="Rajendra Singh"></div>
                                            <div class="col-md-6"><label for="fatherDob" class="form-label required">Father's Date of Birth</label><input type="date" id="fatherDob" name="fatherDob" class="form-control" value="1965-01-10"></div>
                                            <div class="col-md-6"><label for="fatherOccupation" class="form-label required">Father's Occupation</label><input type="text" id="fatherOccupation" name="fatherOccupation" class="form-control" value="Retired Govt. Employee"></div>
                                            ...
                                            <div class="col-md-6"><label for="motherNameP2" class="form-label required">Mother's Name</label><input type="text" id="motherNameP2" name="motherNameP2" class="form-control" value="Sunita Singh"></div>
                                            <div class="col-md-6"><label for="motherDob" class="form-label required">Mother's Date of Birth</label><input type="date" id="motherDob" name="motherDob" class="form-control" value="1968-05-20"></div>
                                            <div class="col-md-6"><label for="motherOccupation" class="form-label required">Mother's Occupation</label><input type="text" id="motherOccupation" name="motherOccupation" class="form-control" value="Homemaker"></div>
                                        </div>
                                    </fieldset>
                               </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div id="educationEntriesContainer">
                                            <div class="row g-3 education-entry">
                                                <div class="col-md-6"><label for="eduQualification_0" class="form-label required">Qualification</label><input type="text" id="eduQualification_0" name="eduQualification[]" class="form-control" value="B.Sc. Computer Science"></div>
                                                <div class="col-md-6"><label for="eduBoardUniversity_0" class="form-label required">Board/University</label><input type="text" id="eduBoardUniversity_0" name="eduBoardUniversity[]" class="form-control" value="University of Delhi"></div>
                                                <div class="col-md-4"><label for="eduSubject_0" class="form-label required">Subject</label><input type="text" id="eduSubject_0" name="eduSubject[]" class="form-control" value="Computer Science"></div>
                                                <div class="col-md-4"><label for="eduPassingYear_0" class="form-label required">Passing Year</label><input type="number" id="eduPassingYear_0" name="eduPassingYear[]" class="form-control" value="2013"></div>
                                                <div class="col-md-4"><label for="eduPercentageGrade_0" class="form-label required">Percentage/Grade</label><input type="text" id="eduPercentageGrade_0" name="eduPercentageGrade[]" class="form-control" value="78%"></div>
    ...
    <div id="workExperienceDetailsDiv" class="conditional-section mt-2">
            ...
            <div class="col-12">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input type="radio" id="pfAccountYes" name="pfAccount" value="yes" class="form-check-input" checked>
        ...
        <div id="pfAccountDetailsDiv" class="row g-3 conditional-section">
            <div class="col-md-6">
                ...
                <input type="text" id="pfUanNo" name="pfUanNo" class="form-control" value="100987654321">
            </div>
            <div class="col-md-6">
                <label for="pfEsiNo" class="form-label">ESI No.</label>
                <input type="text" id="pfEsiNo" name="pfEsiNo" class="form-control" value="2001234567">
            </div>
        </div>
        <hr>
        ...
        <button type="button" id="addExperienceBtn" class="btn btn-secondary btn-sm mt-3">Add Another Experience</button>
                               ...
                               <div class="form-page" id="page4">
                                    ...
                                    <fieldset class="mt-4">
                                        ...
                                        <div id="referenceEntriesContainer">
                                            <div class="card card-body mb-3 reference-block">
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6"><label for="refName_0" class="form-label required">Name</label><input type="text" id="refName_0" name="refName[]" class="form-control" value="Mr. Rajesh Verma"></div>
                                                    <div class="col-md-6"><label for="refContactNo_0" class="form-label required">Contact No.</label><input type="tel" id="refContactNo_0" name="refContactNo[]" class="form-control" value="9876512345"></div>
                                                    <div class="col-12"><label for="refAddress_0" class="form-label required">Address</label><input type="text" id="refAddress_0" name="refAddress[]" class="form-control" value="Tech Park, Bangalore"></div>
                                                </div>
                                            </div>
                                            <div class="card card-body mb-3 reference-block">
                                                <h5 class="card-title">Reference 2</h5>
                                                <div class="row g-3">
                                                    <div class="col-md-6"><label for="refName_1" class="form-label required">Name</label><input type="text" id="refName_1" name="refName[]" class="form-control" value="Ms. Anjali Mehta"></div>
                                                    <div class="col-md-6"><label for="refContactNo_1" class="form-label required">Contact No.</label><input type="tel" id="refContactNo_1" name="refContactNo[]" class="form-control" value="9123498765"></div>
                                                    <div class="col-12"><label for="refAddress_1" class="form-label required">Address</label><input type="text" id="refAddress_1" name="refAddress[]" class="form-control" value="Innovate Hub, Pune"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="mt-4">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6"><label for="bankName" class="form-label required">Bank Name</label><input type="text" id="bankName" name="bankName" class="form-control" value="State Bank of India"></div>
                                            <div class="col-md-6"><label for="bankAccountNumber" class="form-label required">Account Number</label><input type="text" id="bankAccountNumber" name="bankAccountNumber" class="form-control" value="123456789012"></div>
                                            <div class="col-md-6"><label for="bankIfsc" class="form-label required">IFSC Code</label><input type="text" id="bankIfsc" name="bankIfsc" class="form-control" value="SBIN0000001"></div>
                                    ...
                                    <fieldset class="mt-4">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" id="declarationCheck" name="declarationCheck" class="form-check-input" checked>
